...
\title{\centering The Sharp Tail of Uniform Stability}

\author{\makebox[\linewidth][c]{\begin{tabular}{c@{\hspace{3.5em}}c}\textbf{Pahan Dewasurendra} & \textbf{Nuwan Dewasurendra}\\ Johns Hopkins University & MiraCosta College\end{tabular}}}
